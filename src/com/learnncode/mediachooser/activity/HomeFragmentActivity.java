	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(getIntent() != null && (getIntent().getBooleanExtra("isFromBucket", false))){
			...
			if(getIntent().getBooleanExtra("image", false)){
				...
				Button button = new Button(BMapApiApp.getInstance());
				button.setBackgroundColor(Color.parseColor("#ff0000"));
				mTabHost.addTab(mTabHost.newTabSpec("tab1").setIndicator(button).
						setIndicator(getResources().getString(R.string.image) + "     "), ImageFragment.class, bundle);
