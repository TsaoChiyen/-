...
public class VideoLoadAsync extends MediaAsync<String,String, String>{
	...
	public VideoLoadAsync(Object object, ImageView imageView, boolean isScrolling, int width) {
		mImageView    = imageView;
		mObject = object;
		mWidth        = width;
		mIsScrolling  = isScrolling;

		final int memClass = ((ActivityManager)BMapApiApp.getInstance().getSystemService(Context.ACTIVITY_SERVICE))
				.getMemoryClass();
	...
	protected void onPostExecute(String result) {
		mCache.loadBitmap(mObject, result, mImageView, mIsScrolling);
	}
