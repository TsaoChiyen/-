...
public class PushChatMessage implements PushMessage{
	 ...
	 */
	public static final String ACTION_SEND_MESSAGE = "com.weiyuan.sns.push.ACTION_SEND_MESSAGE";
	/**
	 * 返回发送消息的结果<br/>
	 * 附加消息:{@link PushChatMessage#EXTRAS_MESSAGE}
	 */
	public static final String ACTION_SEND_STATE = "com.weiyuan.sns.push.ACTION_SEND_STATE";
	/**
	 * 附加信息变量.<br/>
