...
public class BaseActivity extends FragmentActivity implements OnClickListener{
	...
	protected TextView goodsCountTextView;
	protected RelativeLayout mShoopingCartBtn;
	/**显示右上角购物车图标*/
	protected void setRightTextTitleContent(int left_src_id, int right_src_id, int title_id,int goodsCount){
		mLeftBtn = (LinearLayout)findViewById(R.id.left_btn);
		mLeftIcon = (ImageView)findViewById(R.id.left_icon);
		mRightBtn = (ImageView)findViewById(R.id.right_btn);
		mRightTextBtn = (TextView)findViewById(R.id.right_text_btn);
		...
		titileTextView = (TextView)findViewById(R.id.title);
		mShoopingCartBtn = (RelativeLayout)findViewById(R.id.shooping_count);
		mShoopingCartBtn.setVisibility(View.VISIBLE);
		goodsCountTextView = (TextView)findViewById(R.id.goods_count);
	...
	protected void stopMsg(int loadType,Handler mHandler){
		switch (loadType) {
