...
public class GlobleType {
	...
	public final static int MEETING_CHAT = 500;//秘室
	...
	public final static int BLOCKLISTACTIVITY_APPLY_MEETING_USER_TYPE = 5;//申请秘室人员列表
...
*/	
	...
	//获取地图位置
	public static final int RESQUEST_MAP_LOACTION = 100;
	

	//评论商品
	public static final int REQUEST_GOODS_COMMENT = 0x111;
	
	
	
	
	/**发现游戏*/
	public final static int FOUND_GAME =  0;

	/**发现热门广场*/
	public final static int FOUND_HOTQUEE =  1;

	/**发现爱FUN活动*/
	public final static int FOUND_FUN_EVENT =  2;

	/**发现- 爱FUN商城*/
	public final static int FOUND_FUN_MALL =  3;
