...
import com.chengxin.adapter.RoomAdapter;
import com.chengxin.global.GlobalParam;
import com.chengxin.global.WeiYuanCommon;
import com.chengxin.map.BMapApiApp;
import com.chengxin.net.WeiYuanException;
import com.chengxin.widget.SearchDialog;

public class MyGroupListActivity extends BaseActivity{
	public final static String DELETE_ROOM_SUCCESS = "weiyuan_delete_contact_room_success";
	public final static String DELETE_ROOM_ACTION = "weiyuan_delete_room_action";
		...
		new Thread(){
			public void run() {
				try {
					...
					RoomList roomList = WeiYuanCommon.getWeiYuanInfo().getRoomList(null);
