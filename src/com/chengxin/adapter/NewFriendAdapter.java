	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        holder.mCancelBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				switch (user.type) {
				case 0://发送添加好友邀请
					WeiYuanCommon.sendMsg(mHandler, GlobalParam.MSG_VALID_FRIENDS,position);
					break;
				case 3://添加好友
					WeiYuanCommon.sendMsg(mHandler, GlobalParam.MSG_AGREE_ADD_FRIENDS_REQUEST,position);
					break;
				case 2://等待验证不处理
					break;
