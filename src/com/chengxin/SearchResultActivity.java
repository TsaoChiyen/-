...
public class SearchResultActivity extends BaseActivity implements OnClickListener, OnItemClickListener{
	...
	public static final String REFRSCH_ITEM_ACTION = "com.weiyuan.intent.action.refresh_ACTION";
		...
		new Thread(){
			public void run() {
				try {
					...
					if (isExitsData) {
						mUser = WeiYuanCommon.getWeiYuanInfo().search_number(mSearchContent,page);
