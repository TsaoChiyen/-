...
import com.chengxin.adapter.MessageMovingAdapter;
...
public class MyMovingMessageListActivity extends BaseActivity implements OnItemClickListener{
	...
	private void setListData(){
		...
		if(WeiYuanCommon.getMovingResult(mContext)!=null &&
				WeiYuanCommon.getMovingResult(mContext).size()>0){
			mListData.addAll( WeiYuanCommon.getMovingResult(mContext));
		}
	...
	public void onClick(View v) {
		...
		case R.id.right_text_btn:
			WeiYuanCommon.saveMoving(mContext, null);
			setListData();
			break;
