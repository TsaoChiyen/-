...
import com.chengxin.adapter.MettingAdapter;
import com.chengxin.global.FeatureFunction;
import com.chengxin.global.GlobalParam;
import com.chengxin.global.GlobleType;
import com.chengxin.global.WeiYuanCommon;
import com.chengxin.net.WeiYuanException;
import com.chengxin.widget.MeetingSearchDialog;
...
public class MettingActivity extends BaseActivity implements OnChangeStateListener, OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		WeiYuanCommon.saveReadMeetingTip(mContext, true);
		initCompent();
		...
		new Thread(){
			public void run() {
				try {
					...
					if (isExitsData) {
						mMyAlbum = WeiYuanCommon.getWeiYuanInfo().meetingList(mSelectType,page);
						if ((loadType == GlobalParam.LIST_LOAD_FIRST || loadType == GlobalParam.LIST_LOAD_REFERSH)) {
